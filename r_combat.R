...
dat <- matrix(c(1, 2, NA, 4, 5, 6, 7, 8, 9, 10,
                NA, 12, 13, 14, 15, 16, 17, 18, 19, NA,
                21, NA, 23, 24, 25, 26, 27, 28, 29, NA), nrow = 3, ncol = 10, byrow = TRUE)
...
data.harmonized <- combat_fit(dat, as.factor(batch), mod,eb = TRUE, verbose = TRUE) 